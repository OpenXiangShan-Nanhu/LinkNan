...
set noc_clk_period [get_property PERIOD [get_clocks noc_clk_ln_quad_noc_pll_0]]
set cpu_clk_period [get_property PERIOD [get_clocks core_clk_ln_quad_core_0_pll_0]]
...
-group [get_clocks noc_clk_ln_quad_noc_pll_0] \
-group [get_clocks peri_clk_ln_quad_noc_pll_0] \
-group [get_clocks core_clk_ln_quad_core_0_pll_0] \
-group [get_clocks core_clk_ln_quad_core_1_pll_0] \
-group [get_clocks core_clk_ln_quad_core_2_pll_0] \
-group [get_clocks core_clk_ln_quad_core_3_pll_0] \
...
# SF meta ram is implemeted with BRAM, s1h0l2
set_multicycle_path -setup -from [get_pins $hnx_sf_meta/ram/array/mem/*mem_reg*/CLK*] -to [get_pins $hnx_sf_meta/dataReg*/D] 2
set_multicycle_path -hold  -from [get_pins $hnx_sf_meta/ram/array/mem/*mem_reg*/CLK*] -to [get_pins $hnx_sf_meta/dataReg*/D] 1
...
set_property ASYNC_REG TRUE [get_cells $ln_path/cc_*/tile/cpc/pSlv/asyncSink/sink_d*_reg*]
